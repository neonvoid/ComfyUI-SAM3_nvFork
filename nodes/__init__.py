...
from .load_model_v31 import NODE_CLASS_MAPPINGS as LOAD_MODEL_V31_MAPPINGS
from .load_model_v31 import NODE_DISPLAY_NAME_MAPPINGS as LOAD_MODEL_V31_DISPLAY_MAPPINGS
from .nv_sam3_diag import NODE_CLASS_MAPPINGS as SAM3_DIAG_MAPPINGS
from .nv_sam3_diag import NODE_DISPLAY_NAME_MAPPINGS as SAM3_DIAG_DISPLAY_MAPPINGS
...
# D-354 — batch sibling of SAM3AddPrompt consuming NV_DWPoseToSAM3Seeds
# SAM3_SEED_PROMPTS JSON. See node_notes/architecture/
# 2026-05-18_dwpose_to_sam3_seeds_v6_spec.md in the NV_Comfy_Utils suite.
from .sam3_multi_frame_add_prompt import NODE_CLASS_MAPPINGS as MULTI_FRAME_ADD_PROMPT_MAPPINGS
from .sam3_multi_frame_add_prompt import NODE_DISPLAY_NAME_MAPPINGS as MULTI_FRAME_ADD_PROMPT_DISPLAY_MAPPINGS

# Combine all node mappings
NODE_CLASS_MAPPINGS = {}
NODE_CLASS_MAPPINGS.update(LOAD_MODEL_MAPPINGS)
NODE_CLASS_MAPPINGS.update(LOAD_MODEL_V31_MAPPINGS)
NODE_CLASS_MAPPINGS.update(SAM3_DIAG_MAPPINGS)
...
NODE_CLASS_MAPPINGS.update(MULTI_FRAME_ADD_PROMPT_MAPPINGS)

NODE_DISPLAY_NAME_MAPPINGS = {}
NODE_DISPLAY_NAME_MAPPINGS.update(LOAD_MODEL_DISPLAY_MAPPINGS)
NODE_DISPLAY_NAME_MAPPINGS.update(LOAD_MODEL_V31_DISPLAY_MAPPINGS)
NODE_DISPLAY_NAME_MAPPINGS.update(SAM3_DIAG_DISPLAY_MAPPINGS)
...
NODE_DISPLAY_NAME_MAPPINGS.update(MULTI_FRAME_ADD_PROMPT_DISPLAY_MAPPINGS)
