...
from sam3_v31.model.decoder import (
...
from sam3_v31.model.encoder import TransformerEncoderFusion, TransformerEncoderLayer
from sam3_v31.model.geometry_encoders import SequenceGeometryEncoder
from sam3_v31.model.maskformer_segmentation import PixelDecoder, UniversalSegmentationHead
from sam3_v31.model.memory import (
    CXBlock,
    SimpleFuser,
    SimpleMaskDownSampler,
    SimpleMaskEncoder,
)
from sam3_v31.model.model_misc import (
    DotProductScoring,
    MLP,
    MultiheadAttentionWrapper as MultiheadAttention,
    TransformerWrapper,
)
from sam3_v31.model.multiplex_utils import MultiplexController
from sam3_v31.model.necks import Sam3DualViTDetNeck, Sam3TriViTDetNeck
from sam3_v31.model.position_encoding import PositionEmbeddingSine
from sam3_v31.model.sam1_task_predictor import SAM3InteractiveImagePredictor
from sam3_v31.model.sam3_image import Sam3Image, Sam3ImageOnVideoMultiGPU
from sam3_v31.model.sam3_tracking_predictor import Sam3TrackerPredictor
from sam3_v31.model.sam3_video_inference import Sam3VideoInferenceWithInstanceInteractivity
from sam3_v31.model.sam3_video_predictor import Sam3VideoPredictorMultiGPU
from sam3_v31.model.text_encoder_ve import VETextEncoder
from sam3_v31.model.tokenizer_ve import SimpleTokenizer
from sam3_v31.model.video_tracking_multiplex import VideoTrackingDynamicMultiplex
from sam3_v31.model.vitdet import ViT
from sam3_v31.model.vl_combiner import SAM3VLBackbone, SAM3VLBackboneTri, TriHeadVisionOnly
from sam3_v31.sam.transformer import RoPEAttention
...
def _create_sam3_model(
    ...
    matcher = None
    if not eval_mode:
        from sam3_v31.train.matcher import BinaryHungarianMatcherV2
...
def build_sam3_image_model(
    ...
    if bpe_path is None:
        bpe_path = pkg_resources.resource_filename(
            "sam3_v31", "assets/bpe_simple_vocab_16e6.txt.gz"
        )
...
def build_sam3_multiplex_video_model(
    ...
    from sam3_v31.model.video_tracking_multiplex_demo import Sam3VideoTrackingMultiplexDemo
...
def build_sam3_multiplex_video_predictor(
    ...
    from sam3_v31.model.sam3_multiplex_base import Sam3MultiplexPredictorWrapper
    from sam3_v31.model.sam3_multiplex_detector import Sam3MultiplexDetector
    from sam3_v31.model.sam3_multiplex_tracking import (
        Sam3MultiplexTrackingWithInteractivity,
    )
    from sam3_v31.model.sam3_multiplex_video_predictor import Sam3MultiplexVideoPredictor
