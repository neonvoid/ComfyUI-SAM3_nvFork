...
import numpy as np
import sam3_v31.model.sam3_multiplex_base
import sam3_v31.model.sam3_video_base
import torch
...
from sam3_v31.model.data_misc import BatchedDatapoint
from sam3_v31.model.sam3_multiplex_base import MaskletConfirmationStatus, Sam3MultiplexBase
from sam3_v31.model.sam3_tracker_utils import fill_holes_in_mask_scores
from sam3_v31.model.sam3_video_inference import is_image_type
from sam3_v31.perflib.compile import (
    clone_output_wrapper,
    compile_wrapper,
    shape_logging_wrapper,
)
from sam3_v31.perflib.masks_ops import mask_iou, masks_to_boxes as perf_masks_to_boxes
...
from sam3_v31.model.data_misc import (
    BatchedPointer,
    convert_my_tensors,
    FindStage,
    NestedTensor,
...
from sam3_v31.model.io_utils import load_resource_as_video_frames
