...
from sam3_v31.model.model_misc import AttentionType, LayerScale
from sam3_v31.perflib.fused import addmm_act
from sam3_v31.sam.rope import apply_rotary_enc_real, VisionRotaryEmbeddingVE
...
class Attention(nn.Module):
    ...
    def forward(self, x: Tensor) -> Tensor:
        ...
        if self.attn_type == AttentionType.Vanilla:
            if self.use_fa3:
                from sam3_v31.perflib.fa3 import flash_attn_func
