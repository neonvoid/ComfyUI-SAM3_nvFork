...
from sam3_v31.model.sam3_tracker_utils import get_1d_sine_pe, select_closest_cond_frames
from sam3_v31.sam.mask_decoder import MaskDecoder, MLP
from sam3_v31.sam.prompt_encoder import PromptEncoder
from sam3_v31.sam.transformer import TwoWayTransformer
from sam3_v31.train.data.collator import BatchedDatapoint
...
class Sam3TrackerBase(torch.nn.Module):
    ...
    def _compile_all_components(self):
        ...
        from sam3_v31.perflib.compile import compile_wrapper
